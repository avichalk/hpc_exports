...
#    sc.render()
    #sc.show()
#    os.chdir("/home/u20/avichalk/exports/2-4")
#    sc.save(str(str(file_list_2[i])+str(i))) # weirdest error ever? and i don't know why it's happening? not a big deal, though
   # did end up wasting some time but it's the weekend so
#    print('Done with', str(file_list_2[i]))
#    del data
#    i += 1
# wloop through 2nd dir
